...
<table border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
        ...
        <td align="center" valign="top">
            ...
            <form name="form" method="post" action="netInformation?method=addNews" onsubmit="return checkNews(form)">
                <table width="435" height="319" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        <td width="76" height="25">标题:</td>
                        <td width="359"><input type="text" name="con_title"></td>
                    </tr>
                    <tr>
                        <td height="25">类型:</td>
                        <td>
                    ...
                    <tr>
                        <td height="244">内容:</td>
                        <td>
                            <textarea name="con_content" cols="55" rows="20"></textarea>
                        </td>
                    </tr>
