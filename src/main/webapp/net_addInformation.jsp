...
<table border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
        <td width="195" height="388" align="center" valign="top" bgcolor="EBEBED">
            <jsp:include page="left.jsp" flush="true"></jsp:include>
        </td>
        <td width="632" align="center" valign="top">

            <table width="632" height="48" border="0" align="center" cellpadding="0" cellspacing="0" background="images/3.jpg">
                <tr>
                    <td width="64">&nbsp;</td>
                    <td width="568"> 添加网站基本信息 </td>
                </tr>
            </table>
            <form name="form1" method="post" action="netInformation?method=addNetInformation" onsubmit="return checkNetInformation(form1)">
                <table width="382" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        <td width="78" height="50">网站名称：</td>
                        <td width="359">
                            <input type="text" name="net_individual">
                        </td>
                    </tr>
                    <tr>
